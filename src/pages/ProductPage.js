...
export const ProductPage = () => {
  ...
  const images = product.pictures.map((picture) => <img className='product_carousel-image' src={picture.url} onDragStart={handleDragStart} />)
    ...
    <Container className='pt-4' style={{position: 'relative'}}>
        <Row>
           ...
           <Col lg={6} className='pt-4'>
            ...
            {isSuccess && <ToastMsg  bg='info' title='Added to cart' body={`${product.name} is in your cart`} />}
           </Col>
        </Row>
        <div className='my-4'>
          <h3>Similar Products</h3>
          <div className='d-flex justify-content-center aign-items-center flex-wrap'>
